...
router.put('/time-windows/:id', validate(updateTimeWindowSchema), companyController.updateTimeWindow)
...
router.post('/blocked-dates', validate(createBlockedDateSchema), companyController.createBlockedDate)
...
router.patch('/schedulings/:id/documents', validate(validateDocumentSchema), companyController.validateDocument)
